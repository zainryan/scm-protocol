...
inline void delay_unit_impl(ST_Queue<unsigned int> *delay_cycles_queue,
  ...
  if (valid_chip_read_req_with_time ||
      (valid_chip_read_req_with_time = 
       chip_read_req_with_time_queue->read_nb(data_chip_read_req_with_time))) {
    if (timestamp >= delay_cycles + data_chip_read_req_with_time.timestamp) {
      if (delayed_chip_read_req_queue->write_nb(data_chip_read_req_with_time.raw)) {
        valid_chip_read_req_with_time = false;
      }
    }
  }
  ...
  if (valid_chip_read_resp_with_time ||
      (valid_chip_read_resp_with_time = 
       chip_read_resp_with_time_queue->read_nb(data_chip_read_resp_with_time))) {
    if (timestamp >= delay_cycles + data_chip_read_resp_with_time.timestamp) {
      if (delayed_chip_read_resp_queue->write_nb(data_chip_read_resp_with_time.raw)) {
        valid_chip_read_resp_with_time = false;
      }
    }
  }
  ...
  if (valid_chip_write_req_with_time ||
      (valid_chip_write_req_with_time = 
       chip_write_req_with_time_queue->read_nb(data_chip_write_req_with_time))) {
    if (timestamp >= delay_cycles + data_chip_write_req_with_time.timestamp) {
      if (delayed_chip_write_req_queue->write_nb(data_chip_write_req_with_time.raw)) {
        valid_chip_write_req_with_time = false;
      }
    }
  }

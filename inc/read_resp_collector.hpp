...
inline void read_resp_collector_impl (ST_Queue<Chip_Read_Req> *read_req_context_0, 
...
#ifdef COMPILE_UNIT_TESTS
if (reset_read_resp_collector_impl) {
    reset_read_resp_collector_impl = false;
    write_lease = 0;
}
#endif
...
void read_resp_collector (ST_Queue<Chip_Read_Req> *read_req_context_0, 
    ST_Queue<Chip_Read_Resp> *chip_read_resp_queue_0,
    ST_Queue<Chip_Read_Req> *read_req_context_1, 
    ST_Queue<Chip_Read_Resp> *chip_read_resp_queue_1,
    ST_Queue<Chip_Read_Req> *read_req_context_2, 

...
inline void read_resp_mux_impl(
...
void read_resp_mux(
  ...
  while (1) {
#pragma HLS pipeline
    read_resp_mux_impl(read_req_context_0, chip_read_resp_queue_0,
                       read_req_context_1, chip_read_resp_queue_1,
                       read_req_context_2, chip_read_resp_queue_2,
                       read_req_context_3, chip_read_resp_queue_3,
                       chip_read_resp_with_addr_queue, &write_lease);
  }
}

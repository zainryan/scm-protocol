...
#pragma HLS unroll
      command.index = super_command.data(
          i + COMMAND_SIZE_IN_BIT - 1,
          i + COMMAND_NUM_SIZE_IN_BIT + COMMAND_ISREAD_SIZE_IN_BIT);
      command.num = super_command.data(
          i + COMMAND_NUM_SIZE_IN_BIT + COMMAND_ISREAD_SIZE_IN_BIT - 1,
          i + COMMAND_ISREAD_SIZE_IN_BIT);
      command.is_read =
          super_command.data(i + COMMAND_ISREAD_SIZE_IN_BIT - 1, i);
